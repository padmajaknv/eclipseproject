...
public class ohrmTC6 {
    @Test
    public void TestCase5() throws Exception{
        commonDriver cd=new commonDriver();
        cd.openDriver("https://www.orangehrm.com/");
        ChromeDriver driver=cd.driver;
        WebElement Learn= driver.findElement(By.xpath("(//a[@href='/en/company/careers'])[3]"));
        Actions actions=new Actions(driver);
        actions.moveToElement(Learn).build().perform();
        actions.click().build().perform();
        Thread.sleep(1500);
        String url=driver.getCurrentUrl();
        Assert.assertTrue(url.equals("https://www.orangehrm.com/en/company/careers"));
        driver.quit();
    }
}
